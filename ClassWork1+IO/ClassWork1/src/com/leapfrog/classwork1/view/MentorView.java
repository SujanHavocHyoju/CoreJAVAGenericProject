...
public class MentorView {
    ...
    public void submenu() {
        ...
        System.out.println("5. Export Mentor Records");
        System.out.println("6. Import Mentor Records");
    ...
    public void exportScreen() throws IOException{
        ...
        mentorService.getAll().forEach(mm ->{
        builder.append(mm.toCSV());
        });
        mentorService.export(fileName, builder.toString());
    ...
    public void importDataScreen() throws IOException{
        ...
        String fileName = input.next();
        mentorService.importData(fileName);
        System.out.println("Import Successful !");
        
    }

    public void mentorController() throws IOException {
        boolean back = false;
        while (true) {
            submenu();
