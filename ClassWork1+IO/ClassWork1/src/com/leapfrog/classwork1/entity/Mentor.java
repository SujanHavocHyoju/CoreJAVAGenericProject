...
public class Mentor {
    ...
    public Mentor(int id, String firstName, String lastName, String address, String contact, String email, Boolean status) {
        this.id = id;
    ...
    public String toCSV(){
       return id + "," + firstName + "," + lastName + "," + address + "," + contact + "," + email + "," + status +"\r\n";
    }
